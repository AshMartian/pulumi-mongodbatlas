...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v0.0.2-dev.1577751581+g49707d2.dirty'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v0.0.2-dev.1577751581+g49707d2.dirty`
                """)
            else:
                raise
...
setup(name='pulumi_mongodbatlas',
      version='0.0.2.dev1577751581+dirty',
