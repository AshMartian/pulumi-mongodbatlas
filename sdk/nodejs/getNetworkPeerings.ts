 ...
 */
export function getNetworkPeerings(args: GetNetworkPeeringsArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkPeeringsResult> & GetNetworkPeeringsResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetNetworkPeeringsResult> = pulumi.runtime.invoke("mongodbatlas:index/getNetworkPeerings:getNetworkPeerings", {
