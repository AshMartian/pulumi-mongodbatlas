 ...
 */
export function getCloudProviderSnapshotRestoreJobs(args: GetCloudProviderSnapshotRestoreJobsArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudProviderSnapshotRestoreJobsResult> & GetCloudProviderSnapshotRestoreJobsResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetCloudProviderSnapshotRestoreJobsResult> = pulumi.runtime.invoke("mongodbatlas:index/getCloudProviderSnapshotRestoreJobs:getCloudProviderSnapshotRestoreJobs", {
