 ...
 */
export function getDatabaseUsers(args: GetDatabaseUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseUsersResult> & GetDatabaseUsersResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetDatabaseUsersResult> = pulumi.runtime.invoke("mongodbatlas:index/getDatabaseUsers:getDatabaseUsers", {
