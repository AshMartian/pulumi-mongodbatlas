 ...
 */
export function getNetworkContainer(args: GetNetworkContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkContainerResult> & GetNetworkContainerResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetNetworkContainerResult> = pulumi.runtime.invoke("mongodbatlas:index/getNetworkContainer:getNetworkContainer", {
