 ...
 */
export function getCloudProviderSnapshots(args: GetCloudProviderSnapshotsArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudProviderSnapshotsResult> & GetCloudProviderSnapshotsResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetCloudProviderSnapshotsResult> = pulumi.runtime.invoke("mongodbatlas:index/getCloudProviderSnapshots:getCloudProviderSnapshots", {
