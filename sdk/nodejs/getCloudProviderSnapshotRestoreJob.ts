 ...
 * });
 * const testCloudProviderSnapshotRestoreJob = pulumi.all([testMongodbatlasCloudProviderSnapshotRestoreJob.clusterName, testMongodbatlasCloudProviderSnapshotRestoreJob.id, testMongodbatlasCloudProviderSnapshotRestoreJob.projectId]).apply(([clusterName, id, projectId]) => mongodbatlas.CloudProviderSnapshotRestoreJob({
 ...
 */
export function getCloudProviderSnapshotRestoreJob(args: GetCloudProviderSnapshotRestoreJobArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudProviderSnapshotRestoreJobResult> & GetCloudProviderSnapshotRestoreJobResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetCloudProviderSnapshotRestoreJobResult> = pulumi.runtime.invoke("mongodbatlas:index/getCloudProviderSnapshotRestoreJob:getCloudProviderSnapshotRestoreJob", {
