 ...
 */
export function getCloudProviderSnapshot(args: GetCloudProviderSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudProviderSnapshotResult> & GetCloudProviderSnapshotResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetCloudProviderSnapshotResult> = pulumi.runtime.invoke("mongodbatlas:index/getCloudProviderSnapshot:getCloudProviderSnapshot", {
