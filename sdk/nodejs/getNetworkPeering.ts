 ...
 */
export function getNetworkPeering(args: GetNetworkPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkPeeringResult> & GetNetworkPeeringResult {
    if (!opts) {
        opts = {}
    }
    ...
    const promise: Promise<GetNetworkPeeringResult> = pulumi.runtime.invoke("mongodbatlas:index/getNetworkPeering:getNetworkPeering", {
